        ...
        <div className="relative w-full overflow-hidden">
          ...
          >
            {scrollingIndustries.map((industry, idx) => (
              <div
                key={idx}
                className={`flex flex-col items-center min-w-[180px] max-w-[200px] mx-4 flex-shrink-0 transition-all duration-300 ${
                  expandedIdx === idx ? "max-h-[350px]" : "max-h-[250px]"
                }`}
              >
                <img
                  src={industry.icon}
                  ...
                  draggable="false"
                />
                <h3 className="text-xl font-bold text-center text-primary font-serif mb-1">
                  {industry.title}
                </h3>
                <p className="text-base text-center text-[#555555] font-serif break-words whitespace-normal">
                  {industry.desc}
                </p>
                {expandedIdx === idx && (
                  <button
