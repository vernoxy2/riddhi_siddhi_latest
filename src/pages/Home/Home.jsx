...
const Home = () => {
  return (
    <>
      <div
        className="relative w-full h-[80vh] flex items-center justify-start bg-cover bg-center font-serif"
        style={{ backgroundImage: `url(${homeHeader})` }}
      >
        <div className="ml-16 max-w-xl bg-black bg-opacity-0 p-8 rounded-lg flex flex-col items-start">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-black font-serif">
            Your Trusted Stockist for Industrial Fasteners
          </h1>
          <p className="text-xl md:text-2xl mb-8 text-black font-serif">
            Explore Our Range of Industrial Nuts, Bolts & Screws in MS, SS &
            Brass.
          </p>
          <button className="bg-primary hover:bg-red-600 text-white text-xl font-semibold px-12 py-4 rounded-lg shadow-md transition">
            Get Quote
          </button>
        </div>
      </div>

      <div className="w-full flex flex-col items-center py-12 px-2 md:px-0">
        <div className="max-w-7xl w-full grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex justify-center">
            <img
              ...
              className="rounded-xl shadow-lg object-cover w-[90vw] max-w-xl h-[400px] md:h-[480px]"
            />
          </div>
          {/* Text Section */}
          <div className="flex flex-col justify-center items-start">
            <h2 className="text-5xl font-bold text-primary mb-6 font-serif text-center md:text-left w-full">
              Who We Are
            </h2>
